...
def get_response(url):
    try:
        ...
        porxy_list = [
            ...
            {"http": "http://124.205.155.157:9090"},
            {"http": "http://39.155.253.58:8060"},
            {"http": "http://124.205.155.156:9090"},
            {"http": "http://101.200.49.180:8118"},
            {"http": "http://39.175.85.225:30001"},
            {"http": "http://211.103.138.117:8000"},
            {"http": "http://218.1.142.138:57114"},
            {"http": "http://222.69.240.130:8001"},
            {"http": "http://101.230.4.168:80"},
            {"http": "http://58.37.233.45:8118"},
            {"http": "http://101.94.210.137:7890"},
            {"http": "http://58.37.233.45:8118"},
            {"http": "http://49.85.15.232:9000"},
            {"http": "http://121.232.148.127:9000"},
            {"http": "http://49.75.216.12:8118"},
            {"http": "http://58.240.110.171:8888"},
            {"http": "http://110.80.172.2:16790"},
            {"http": "http://121.207.92.94:3712"},
            {"http": "http://171.92.21.39:9000"},
            {"http": "http://182.139.110.14:9000"},
            {"http": "http://182.139.110.52:9000"},
            {"http": "http://171.92.20.245:9000"},
            {"http": "http://118.114.111.206:8060"},
            {"http": "http://171.92.20.30:9000"},
            {"http": "http://183.245.6.123:8080"},
            {"http": "http://113.214.4.8:84"},
        ]
